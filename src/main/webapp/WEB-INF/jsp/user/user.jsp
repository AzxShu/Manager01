	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
				    ...
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	...
					    	用户状态：<input type="text" name="status" value="${status}">
			...
			<c:forEach items="${requestScope.users}" var="user" varStatus="stat">
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${user.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${ctx}/user/updateUser?flag=1&id=${user.id}&password=${user.password}&status=${user.status}&loginname=${user.loginname}&username=${user.username}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/user/selectUser?pageIndex={0}&username=${username}&status=${status}"/>
	  </td></tr>
	</table>
